...
*/
        ...
        objective.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent i = new Intent(MainActivity.this, Objective.class);
                startActivity(i);
            }
        });
        ...
        personalSummary.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View arg0) {
                Intent i = new Intent(MainActivity.this, Professional_summaryActivity.class);
                startActivity(i);
            }
        });
        ...
        education.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent i = new Intent(MainActivity.this, Education_Activity.class);
                startActivity(i);
            }
        });
        ...
        skills.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                // TODO Auto-generated method stub
                Intent i = new Intent(MainActivity.this, Skills_activity.class);
                startActivity(i);
            }
        });
...
//                    pdfw.setPdfVersion(PdfWriter.VERSION_1_5);
                    ...
                    Font WhiteFont = new Font(Font.FontFamily.HELVETICA, 1, Font.NORMAL, BaseColor.WHITE);
                    ...
                    String DOB = PersonalInfo.getDateOfBirthFormate(choice, day, Month, Year);
...
//                    https://developers.itextpdf.com/question/how-apply-color-strings-paragraph

//                    Chunk blueText = new Chunk("This text is whiteFont. ", WhiteFont);
//                    Chunk greenText = new Chunk("This text is headingFont ", headingFont);
...
//                    document.add(p2);
                        ...
                        Chunk label1 = new Chunk(choice + "", WhiteFont);
                        pT1.add(label1);

                        document.add(pT1);


                        Chunk name = new Chunk(p.getmPersonName(), nameFont);
                        Paragraph pT = new Paragraph();
//                        pT.setFont(headingFont);
                        ...
                        if (p.getmStreetNo() != null && !p.getmStreetNo().isEmpty()) {
                            Chunk label = new Chunk(Global.STREET, WhiteFont);
                            Chunk value = new Chunk(p.getmStreetNo(), contentFont);
                        ...
                        if (p.getmCity() != null && !p.getmCity().isEmpty()) {
                            if (!mAddress.isEmpty()) {
                                mAddress += ", ";
                                Chunk value1 = new Chunk(", ", contentFont);
                                pT.add(value1);
                            }
                            Chunk label = new Chunk(Global.CITY, WhiteFont);
                            pT.add(label);

                            mAddress += p.getmCity();
                            Chunk value = new Chunk(p.getmCity(), contentFont);
                            pT.add(value);
                        }
                        ...
                        if (p.getmState() != null && !p.getmState().isEmpty()) {
                            ...
                            Chunk label = new Chunk(Global.STATE, WhiteFont);
                            pT.add(label);

                            Chunk value = new Chunk(p.getmState(), contentFont);
                        ...
                        if (p.getmCountry() != null && !p.getmCountry().isEmpty()) {
                            ...
                            Chunk label = new Chunk(Global.COUNTRY, WhiteFont);
                            pT.add(label);

                            Chunk value = new Chunk(p.getmCountry(), contentFont);
...
//                            mAddress += p.getmPinOrZip();
                            ...
                            Chunk label = new Chunk(Global.PIN, WhiteFont);
                            pT.add(label);

                            Chunk value = new Chunk(p.getmPinOrZip(), contentFont);
                            mAddress += p.getmPinOrZip();
                            pT.add(value);
                        }
                        ...
                        for (int i = 0; i < mOrderSections.size(); i++) {
                            ...
                            switch (mNextHeader) {
                                case "Objective":
                                    ...
                                    Paragraph pObjective = new Paragraph(sh.getString("message", ""), contentFont);
                                    p1 = new Paragraph("");
...
//                                        p1.setFont(headingFont);
                                        ...
                                        for (ProfessionalSummary job : Summary) {
                                            p1 = new Paragraph("");
                                            Chunk label = new Chunk(Global.PROFESSIONAL_SUMMARY + count + " " + System.getProperty("line.separator"), WhiteFont);
                                            Chunk value = new Chunk(job.toString() + "\n", contentFont);
                                            p1.setLeading(0.1f, 1.0f);
                                            p1.add(label);
                                            p1.add(value);
                                            count++;
...
//                                            p1.setFont(contentFont);
                                ...
                                case "Experience":
                                    ...
                                    ArrayList<ExperienceData> list = ExperienceDataList
                                            ...
                                            .getPendingJobs();
                                    if (list.size() != 0) {
                                        p1 = new Paragraph("Experience", headingFont);
                                        p1.setFont(headingFont);
                                        document.add(p1);
...
//                                            document.add(new Paragraph(Global.EXP_CMPNY_NAME, WhiteFont));
//                                            p1 = new Paragraph(one.getmCompanyName() + "\n", contentFont);
////                                            p1.setFont(contentFont);
//                                            document.add(p1);
////                                            }

                                            Chunk label = new Chunk(Global.EXP_CMPNY_NAME + System.getProperty("line.separator"), WhiteFont);
                                            Chunk value = new Chunk(one.getmCompanyName() + "\n", contentFont);
                                            p1.setLeading(0.1f, 1.0f);
                                            p1.add(label);
                                            p1.add(value);

////                                            if (one.getmDesignation() != null && !one.getmDesignation().isEmpty()) {
//                                            document.add(new Paragraph(Global.EXP_DESIGNATION, WhiteFont));
//                                            p1 = new Paragraph(one.getmDesignation() + "\n", contentFont);
////                                            p1.setFont(contentFont);
//                                            document.add(p1);
////                                            }

                                            Chunk label1 = new Chunk(Global.EXP_DESIGNATION + System.getProperty("line.separator"), WhiteFont);
                                            Chunk value1 = new Chunk(one.getmDesignation() + "\n", contentFont);
                                            p1.add(label1);
                                            p1.add(value1);
                                            ...
                                            //...
                                            dateStr = PersonalInfo.getDateOfBirthFormate4Pdf(choice,
...
//                                                dateStr2 = date.getMonth() + "/" + date.getYear() + "";
                                                ...
                                                dateStr2 = PersonalInfo.getDateOfBirthFormate4Pdf(choice,
                                                        d1.getDate() + "", d1.getMonth() + "", d1.getYear() + "");
                                            ...
                                            if (!dateStr.isEmpty() && !dateStr2.isEmpty()) {
                                                Chunk label2 = new Chunk(Global.EXP_DATE + System.getProperty("line.separator"), WhiteFont);
                                                Chunk value2 = new Chunk(dateStr + "-" + dateStr2 + "\n", contentFont);
                                                p1.add(label2);
                                                p1.add(value2);
...
//                                            if (one.getmWhatDidYouOverThere() != null && !one.getmWhatDidYouOverThere().isEmpty()) {
                                            ...
                                            Chunk label3 = new Chunk(Global.EXP_WHAT_DID_YOU + System.getProperty("line.separator"), WhiteFont);
                                            Chunk value3 = new Chunk(one.getmWhatDidYouOverThere() + "\n", contentFont);
                                            p1.add(label3);
                                            p1.add(value3);

//                                            document.add(new Paragraph(Global.EXP_WHAT_DID_YOU, WhiteFont));
...
//                                            }
                                ...
                                case "Education":
                                    ...
                                    ArrayList<EducationData> list2 = EducationDataList
                                            ...
                                            .getPendingJobs();
                                    if (list2.size() != 0) {
                                        p1 = new Paragraph("Education", headingFont);
                                        p1.setFont(headingFont);
                                        document.add(p1);

                                        for (EducationData one : list2) {
////                                            if (one.getmSchoolName() != null && !one.getmSchoolName().isEmpty()) {
//                                            document.add(new Paragraph(Global.EDU_SCHOOL_NM, WhiteFont));
...
////                                            }
                                            ...
                                            p1 = new Paragraph("");
                                            Chunk label = new Chunk(Global.EDU_SCHOOL_NM + System.getProperty("line.separator"), WhiteFont);
                                            Chunk value = new Chunk(one.getmSchoolName() + "\n", contentFont);
                                            p1.setLeading(0.1f, 1.0f);
                                            p1.add(label);
                                            p1.add(value);
...
//                                                document.add(p1);
                                                ...
                                                Chunk label1 = new Chunk(Global.EDU_DATE + System.getProperty("line.separator"), WhiteFont);
                                                Chunk value1 = new Chunk(dateStr + "-" + dateStr2 + "\n", contentFont);
                                                p1.add(label1);
                                                p1.add(value1);
                                            }

////                                            if (one.getmDegreeName() != null && !one.getmDegreeName().isEmpty()) {
//                                            document.add(new Paragraph(Global.EDU_DEGREE_NM, WhiteFont));
//                                            p1 = new Paragraph(one.getmDegreeName(), contentFont);
//                                            p1.setFont(contentFont);

                                            Chunk label1 = new Chunk(Global.EDU_DEGREE_NM + System.getProperty("line.separator"), WhiteFont);
                                            Chunk value1 = new Chunk(one.getmDegreeName(), contentFont);
                                            p1.add(label1);
                                            p1.add(value1);
                                    ...
                                    if (SkillsSummary.size() != 0) {
                                        ...
                                        for (SkillsData job : SkillsSummary) {
                                            if (job.toString() != null && !job.toString().isEmpty()) {
                                                ...
                                                Chunk label = new Chunk(Global.SKILL + count + " " + System.getProperty("line.separator"), WhiteFont);
                                                Chunk value = new Chunk(job.toString() + "\n", contentFont);
                                                p1.setLeading(0.1f, 1.0f);
                                                p1.add(label);
                                                p1.add(value);
...
//                                                mAward = job.getmNameOfAward();
                                                ...
                                                Chunk label = new Chunk(Global.ACHIEVEMENT_NAME + System.getProperty("line.separator"), WhiteFont);
                                                Chunk value = new Chunk(job.getmNameOfAward() + "\n", contentFont);
                                                p1.setLeading(0.1f, 1.0f);
                                                p1.add(label);
                                                p1.add(value);
...
//                                                int a = sh.getInt(Profile_Info.DATE_FORMATE, 1);
                                                ...
                                                mAwardDate = PersonalInfo.getDateOfBirthFormate4Pdf(choice, job
                                                        .getmDateOfAward().getDate() + "", job.getmDateOfAward()
                                                        .getMonth() + "", job.getmDateOfAward().getYear() + "").trim();

                                                Chunk label = new Chunk(Global.ACHIEVEMENT_DATE + System.getProperty("line.separator"), WhiteFont);
                                                Chunk value = new Chunk(mAwardDate + "\n", contentFont);
                                                p1.add(label);
                                                p1.add(value);
                                            }
...
//                                                mAward = job.getmWhatDidYouDoToAchieveIt();
                                                ...
                                                Chunk label = new Chunk(Global.ACHIEVEMENT_WHAT_DID_YOU + System.getProperty("line.separator"), WhiteFont);
                                                Chunk value = new Chunk(job.getmWhatDidYouDoToAchieveIt() + "\n", contentFont);
                                                p1.add(label);
                                                p1.add(value);
                                            }
...
//
//
//                                            document.add(new Paragraph(Global.ACHIEVEMENT_NAME, WhiteFont));
//                                            document.add(new Paragraph(job.getmNameOfAward(), contentFont));
//                                            document.add(new Paragraph(Global.ACHIEVEMENT_DATE, WhiteFont));
//                                            document.add(new Paragraph(mAwardDate, contentFont));
//                                            document.add(new Paragraph(Global.ACHIEVEMENT_WHAT_DID_YOU, WhiteFont));
//                                            document.add(new Paragraph(job.getmWhatDidYouDoToAchieveIt(), contentFont));
                                    ...
                                    if (ref.size() != 0) {
                                        ...
                                        for (ReferencesData job : ref) {
                                            ...
                                            if (job.getmNameOfCoWorker() != null && !job.getmNameOfCoWorker().isEmpty()) {
                                                ...
                                                Chunk label = new Chunk(Global.REF_NAME + System.getProperty("line.separator"), WhiteFont);
                                                Chunk value = new Chunk(job.getmNameOfCoWorker(), contentFont);
                                                p1.setLeading(0.1f, 1.0f);
                                                p1.add(label);
                                                p1.add(value);
                                            }
                                            ...
                                            if (job.getmDasignationofCoWorker() != null && !job.getmDasignationofCoWorker().isEmpty()) {
                                                if (!mReference.isEmpty()) {
                                                    mReference += ", ";
                                                    Chunk value = new Chunk(", ", contentFont);
                                                    p1.add(value);
                                                }
                                                mReference += job.getmDasignationofCoWorker();

                                                Chunk label = new Chunk(Global.REF_DESIGNATION + System.getProperty("line.separator"), WhiteFont);
                                                Chunk value = new Chunk(job.getmDasignationofCoWorker(), contentFont);
                                                p1.add(label);
                                                p1.add(value);
                                            ...
                                            if (job.getmCompanyName() != null && !job.getmCompanyName().isEmpty()) {
                                                ...
                                                Chunk label = new Chunk(Global.REF_CMPNY_NAME + System.getProperty("line.separator"), WhiteFont);
                                                Chunk value = new Chunk(job.getmCompanyName() + "\n", contentFont);
                                                p1.add(label);
                                                p1.add(value);
                                            }

                                            if (mReference == null || mReference.trim().isEmpty() || !mReference.contains(",")) {
                                                mReference = "\n";
                                            ...
                                            if (job.getmEmailOfCoWorker() != null && !job.getmEmailOfCoWorker().isEmpty()) {
                                                Chunk label = new Chunk(Global.REF_EMAIL + System.getProperty("line.separator"), WhiteFont);
                                                Chunk value = new Chunk(job.getmEmailOfCoWorker() + "\n", contentFont);
                                                p1.add(label);
                                                p1.add(value);
                                            }
//                                            document.add(new Paragraph(mReference, contentFont));
//                                            document.add(new Paragraph(job.getmEmailOfCoWorker(), contentFont));

//                                            document.add(new Paragraph(Global.REF_WHAT_DID_YOU, WhiteFont));
//                                            document.add(new Paragraph(job.getmHowDidYouWorkWithHim(), contentFont));

                                            if (job.getmHowDidYouWorkWithHim() != null && !job.getmHowDidYouWorkWithHim().isEmpty()) {
                                                Chunk label1 = new Chunk(Global.REF_WHAT_DID_YOU + System.getProperty("line.separator"), WhiteFont);
                                                Chunk value1 = new Chunk(job.getmHowDidYouWorkWithHim() + "\n", contentFont);
                                                p1.add(label1);
                                                p1.add(value1);
                                            }
//                                            document.add(new Paragraph("re_ct", WhiteFont));
//                                            document.add(new Paragraph(job.getmContactOfCoWorker(), contentFont));

                                            if (job.getmContactOfCoWorker() != null && !job.getmContactOfCoWorker().isEmpty()) {
                                                Chunk label2 = new Chunk(Global.REF_CONTACT + System.getProperty("line.separator"), WhiteFont);
                                                Chunk value2 = new Chunk(job.getmContactOfCoWorker() + "\n", contentFont);
                                                p1.add(label2);
                                                p1.add(value2);
                                            }
...
//            finish();
    ...
    private void readFile(File file) {
        ...
        try {
            ...
            for (int i = 0; i < n; i++) {
                Log.e(i + "===getTextFromPage===", PdfTextExtractor.getTextFromPage(reader, i + 1).trim() + "");
...
//                break;
    ...
    private void setCustomTheme() {
        Global.setCustomTheme(MainActivity.this, lnr_main);
    ...
    private void facebookBannerAdView() {
        try {
            adView = new AdView(MainActivity.this, (getString(R.string.banner_facebook)), AdSize.BANNER_HEIGHT_50);
    ...
    private void facebookInterstitialAd() {
        interstitialAd = new InterstitialAd(this, getString(R.string.interstitial_facebook));
