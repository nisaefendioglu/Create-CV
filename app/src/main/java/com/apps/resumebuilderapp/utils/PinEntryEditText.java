...
//        int colorFocused = isInEditMode() ? Color.GRAY : ContextCompat.getColor(context, R.color.pin_normal);
        int colorFocused = isInEditMode() ? R.color.colorAccent : ContextCompat.getColor(context, R.color.pin_normal);
        mColors[1] = colorFocused;

//        int colorUnfocused = isInEditMode() ? Color.GRAY : ContextCompat.getColor(context,R.color.pin_normal);
        int colorUnfocused = isInEditMode() ? R.color.colorAccent : ContextCompat.getColor(context, R.color.pin_normal);
...
//        return mColorStates.getColorForState(states, Color.GRAY);
        return mColorStates.getColorForState(states, R.color.colorAccent);
    }
